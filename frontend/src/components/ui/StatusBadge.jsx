...
const STATUS_MAP = {
  ...
  RE: { label: "Runtime Error", color: "text-pink-500" },
  "RE (SIGSEGV)": { label: "RE: Segfault", color: "text-pink-500" },
  "RE (SIGABRT)": { label: "RE: Aborted", color: "text-pink-500" },
  "RE (SIGFPE)": { label: "RE: Float Error", color: "text-pink-500" },
